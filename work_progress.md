...
Современные системы домашней автоматизации являются частным случаем Интернета вещей. Интернет вещей (IoT) - множество устройств объединенных в одну вычислительную сеть, которые генерируют большие объемы данных. 
Разнообразие возможных вариантов протоколов связи, несовместимость программных интерфейсов, и большое количество моделей устройств, создает проблемы при проектировании "умного дома".
